...
<link rel="stylesheet" href="${oss_static_js_css_url}/src/css/getDealDetail.css?version=321332438">
...
<script src="${oss_static_js_css_url}/src/js/haivitDeal_getDealDetail.js?ver=201708111625"></script>
...
<body ng-app="app" ng-controller="ctrl">
    ...
    <div  class="fix_containner" style="margin-top:0">
        ...
        <div class="bg-white" style="padding:10px;">
            <div class="weui-row">
                ...
                <!--<img src="${json_config.oss_common_url}/wap/src/images/icon/login1.png" alt="" style="width:24px">-->
    ...
    <div id="about" class="weui-popup__container  popup-bottom">
        ...
        <div class="weui-popup__modal" style="overflow:inherit;background:white">
            <!--关闭按钮-->
            <p class="toclose close-popup" ng-click="closePop()">关闭</p>
            <!--头部区域-->
            ...
            <!--选择区域,可垂直滚动-->
            <div class="popup-container text-font2" style="overflow-y:scroll;">
               <div ui-sku class="pad-all3" split-str="#" sku-data="skuInfo" on-ok="callback($event)">
                    <#list attr_list as item>
                    	<div class="l-col">${item.name}</div>
                        <div class="r-col">
                            <ul class="m-sku f-cb">
                            	<#list item.list as attrItem>
                                	<li>
                                		<span ng-class="{'js-seleted': keyMap['${item.id + '/' + attrItem.id}'].selected,
                                		'js-disabled': keyMap['${item.id + '/' + attrItem.id}'].disabled}"
                                		ng-click="onSelect('${item.id + '/' + attrItem.id}')">
    ...
    <div class="footer-fixed " id="footer">
        <div class="weui-flex text-c">
            <div class="weui-flex__item">
                <div class="footer-operate mar-t1" onclick="location=project_url+'/'+module+'/index.do';"> <img src="http://common.huibaoming.cn/wap/images/icon/home.png" alt="" style="width:20px"><p>首页</p></div>
                <div class="footer-operate mar-t1" onclick="location=project_url+'/haivitShopCart/index.do';"><img src="http://common.huibaoming.cn/wap/images/icon/search.png" alt="" style="width:20px"><p>购物车</p><span class="shopcar_num" ng-bind="shopcar_num"></span></div>
            </div>
